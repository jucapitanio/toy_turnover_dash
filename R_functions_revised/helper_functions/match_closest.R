#' Function taken from: https://github.com/sgibb/MALDIquant
#' Relaxed Value Matching
#'
#' \code{match_closest} returns a vector of the positions of (first) matches
...
#' @aliases match_closest
#' @export
#' @examples
#' library("MALDIquant")
#' match_closest(c(1.1, 1.4, 9.8), 1:10)
#' # [1]  1  1 10
#' match_closest(c(1.1, 1.4, 9.8), 1:10, tolerance=0.25)
#' # [1]  1 NA 10
#' match_closest(c(1.1, 1.4, 9.8), 1:10, tolerance=0.25, nomatch=0)
#' # [1]  1  0 10
#'
...
#' ref <- c(2.2, 4.8)
#'
#' im[, match_closest(ref, attr(im, "mass"), tolerance=0.25, nomatch=0)]
#' #      2  5
#' # [1,] 3  9
#' # [2,] 4 10
#'
